...
export function authors(location) {
  console.log(document.querySelector('#authors').childElementCount == 0 && prefix(location, 'authors'))
  return document.querySelector('#authors').childElementCount == 0 && prefix(location, 'authors')
